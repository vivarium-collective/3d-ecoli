...
SKIPPED with the reproduction requirement (see ecoli_3d/acceptance.py and
SUMMARY.md) — never silently passed.
"""
import pytest

from ecoli_3d.acceptance import (
...
def test_selection_layer_conserves_counts_and_caps_top_n():
    ...
    from ecoli_3d.build import _proteins
    prot = _proteins()
