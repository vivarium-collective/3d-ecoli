...
``ecoli_3d.pack_step.EcoliPackStep`` as one more FINAL execution layer on
every per-agent cell state, mirroring exactly how ``baseline()`` itself
appends its own ``shape_step`` final layer (see baseline.py:895-919).
"""
